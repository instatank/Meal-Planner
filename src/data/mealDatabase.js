import { enrichMealForDataLayer } from '../lib/mealDataLayer.js';
  ...
  "lunchDinner": [
    ...
    },
    {
      ...
      "components": {
        ...
        "amount": 150,
        "carb": "Spaghetti aglio e olio (small portion)",
        "carbAmount": 100,
        "veg": "Sautéed broccoli",
        "vegAmount": 150,
        "style": "Grilled"
      },
      "protein": 44,
    ...
    },
    {
      ...
      "components": {
        "protein": "Grilled salmon",
        "amount": 150,
        "carb": "Garlic rice (small portion)",
        "carbAmount": 100,
        "veg": "Sautéed broccoli",
        "vegAmount": 150,
        "style": "Grilled"
    ...
    },
    {
      ...
      "components": {
        ...
        "carb": "No carb",
        "carbAmount": 0,
        "veg": "Smoked chicken + avocado salad",
        "vegAmount": 120,
        "style": "Tandoori"
      },
      "protein": 61,
...
export const mealDatabase = Object.fromEntries(
  Object.entries(baseMealDatabase).map(([mealType, meals]) => [
    mealType,
    meals.map((meal) => enrichMealForDataLayer(meal, mealType))
  ])
);
